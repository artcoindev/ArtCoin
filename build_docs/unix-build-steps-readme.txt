...
to complete. Your PC or VM must have at least 1.5 GB of RAM or Artcoin will 
...
Install dependencies needed to compile Artcoin: 
--------------------- 
...
Qt GUI wallet build + extra dependencies: (if you have already built the daemon you wont need to clone the Artcoin repository)
--------------------
cd $HOME
mkdir $HOME/deps
cd $HOME/deps
