...
static const int64_t MAX_MINT_PROOF_OF_STAKE = 0.004 * COIN;	// 0.4% annual interest
...
public:
    ...
    {
        // artcoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // artcoin: get transaction coin age
...
public:
    ...
    // artcoin: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // artcoin: two types of block: proof-of-work or proof-of-stake
    ...
    // artcoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // artcoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // artcoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // artcoin: block index flags
    enum  
    {
