...
void StatisticsPage::updateStatistics()
{
    ...
    double nSubsidy = (uint64_t)GetProofOfWorkReward(0);
    ...
    QString phase = "PoW + PoS hybrid";
    QString subsidy = QString::number((nSubsidy / 100000000), 'f', 5);
    ...
    {
        ui->heightBox->setText("<b><font color=\"blue\">" + height + "</font></b>");
    } else {
    ...
    {
        ui->minBox->setText("<b><font color=\"blue\">" + stakemin + "</font></b>");
    } else {
    ui->minBox->setText(stakemin);
    }
    if(0 > stakemaxPrevious)
    {
        ui->maxBox->setText("<b><font color=\"blue\">" + stakemax + "</font></b>");
    } else {
    ...
    {
        ui->cBox->setText("<b><font color=\"blue\">" + phase + "</font></b>");
    } else {
    ...
    {
        ui->diffBox->setText("<b><font color=\"blue\">" + hardness + "</font></b>");
    ...
    {
        ui->diffBox2->setText("<b><font color=\"blue\">" + hardness2 + "</font></b>");
    ...
    {
        ui->pawrateBox->setText("<b><font color=\"blue\">" + pawrate + " MH/s</font></b>");
    ...
    {
        ui->localBox->setText("<b><font color=\"blue\">" + Qlpawrate + "</font></b>");
    } else {
    ...
    {
        ui->connectionBox->setText("<b><font color=\"blue\">" + QPeers + "</font></b>");
    ...
    {
        ui->volumeBox->setText("<b><font color=\"blue\">" + qVolume + " ART" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " ART" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " ART");
    }
