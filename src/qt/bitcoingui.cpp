...
#ifdef Q_OS_MAC
    resize(960, 610);
    setWindowTitle(tr("Artcoin wallet - Mac"));
#elif _WIN32
    resize(870, 600);
    setWindowTitle(tr("Artcoin wallet - Windows"));
#else
    resize(1030, 650);
    setWindowTitle(tr("Artcoin wallet - Linux"));
#endif
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a artcoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About artcoin"), this);
    aboutAction->setToolTip(tr("Show information about artcoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for artcoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Artcoin core - ") + ("client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Artcoin Core - client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to artcoin network", "", count));
}
...
void BitcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
    ...
    if (!strStatusBarWarnings.isEmpty())
    {
        ...
        progressBarLabel->setStyleSheet("QLabel { background-color: #FA7A2A; color: #000000; font-weight: bold;}");
        progressBarLabel->setVisible(true);
        progressBar->setVisible(false);
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid artcoin address or malformed URI parameters."));
    }
